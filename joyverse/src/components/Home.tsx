...
//           <Logo>Joyverse</Logo>
//           <LogoStars>
//             <Star color="#FF6B6B" top="-10px" left="15px" size="15px" rotate="15deg" />
//             <Star color="#FFD166" top="5px" left="100px" size="12px" rotate="-10deg" />
//           </LogoStars>
//         </LogoContainer>
//         <MenuItems>
...
//           <ActionMenuItem><ActionLink to="/signup">Sign Up</ActionLink></ActionMenuItem>
//         </MenuItems>
//       </Navbar>
...
//           </HeroContent>
//           <StarDecorations>
//             <Star color="#FF6B6B" top="20px" right="40px" size="30px" rotate="15deg" />
//             <Star color="#4ECDC4" bottom="30px" left="20px" size="25px" rotate="-10deg" />
//             <Star color="#FFD166" top="60%" right="15%" size="20px" rotate="25deg" />
//           </StarDecorations>
//         </HeroSection>
...
//           </SectionTitle>
//           <FAQItem>
//             <Question>What is Joyverse?</Question>
//             <Answer>Joyverse is an educational platform designed specifically for dyslexic children. We combine evidence-based learning approaches with interactive games to make education accessible, engaging, and effective. Our platform adapts to each child's unique learning style and pace, offering personalized support along their educational journey.</Answer>
//           </FAQItem>
//           <FAQItem>
//             <Question>How does it work?</Question>
//             <Answer>It uses therapist-guided educational games to support learning. Our platform features interactive exercises that target core literacy skills while building confidence. Each activity adjusts to your child's abilities, gradually increasing in complexity as they master new concepts. Progress reports help parents and educators track development and celebrate achievements along the way.</Answer>
//           </FAQItem>
//           <FAQItem>
//             <Question>What age group is Joyverse designed for?</Question>
//             <Answer>Joyverse is primarily designed for children aged 6-12, but can be beneficial for learners of various ages. Our content scales in difficulty and presentation style to accommodate different developmental stages. We offer beginner, intermediate, and advanced activities to ensure appropriate challenges regardless of where your child is in their learning journey.</Answer>
//           </FAQItem>
//           <FAQItem>
//             <Question>Is Joyverse only for children with dyslexia?</Question>
//             <Answer>While Joyverse is specifically designed with dyslexic learners in mind, our approach benefits children with various learning styles. The platform's multisensory techniques, adaptive pacing, and engaging format make it valuable for any child who might struggle with traditional learning methods or who simply enjoys interactive educational experiences.</Answer>
//           </FAQItem>
//           <FAQItem>
//             <Question>Do you offer parent resources?</Question>
//             <Answer>Absolutely! We provide comprehensive resources for parents including progress tracking, suggested at-home activities, and regular reports on your child's development. Our parent portal offers articles on supporting dyslexic learners, webinars with education specialists, and a community forum where you can connect with other families on similar journeys.</Answer>
//           </FAQItem>
//         </FAQSection>
...
//           </SectionContent>
//           <FeedbackButton to="/feedback">Share Your Thoughts</FeedbackButton>
//         </FeedbackSection>
//       </ContentWrapper>
...
//                   answer: "It uses therapist-guided educational games to support learning. Our platform features interactive exercises that target core literacy skills while building confidence. Each activity adjusts to your child's abilities, gradually increasing in complexity as they master new concepts. Progress reports help parents and educators track development and celebrate achievements along the way."
//                 },
//                 {
//                   question: "What age group is Joyverse designed for?",
//                   answer: "Joyverse is primarily designed for children aged 6-12, but can be beneficial for learners of various ages. Our content scales in difficulty and presentation style to accommodate different developmental stages. We offer beginner, intermediate, and advanced activities to ensure appropriate challenges regardless of where your child is in their learning journey."
//                 },
//                 {
//                   question: "Is Joyverse only for children with dyslexia?",
//                   answer: "While Joyverse is specifically designed with dyslexic learners in mind, our approach benefits children with various learning styles. The platform's multisensory techniques, adaptive pacing, and engaging format make it valuable for any child who might struggle with traditional learning methods or who simply enjoys interactive educational experiences."
//                 },
//                 {
//                   question: "Do you offer parent resources?",
//                   answer: "Absolutely! We provide comprehensive resources for parents including progress tracking, suggested at-home activities, and regular reports on your child's development. Our parent portal offers articles on supporting dyslexic learners, webinars with education specialists, and a community forum where you can connect with other families on similar journeys."
//                 }
//               ].map((faq, index) => (
//                 <FAQItem key={index}>
...
//   /* Apply background with a pattern overlay instead of relying on an image */
//   &::before {
//     content: '';
//     position: fixed;
//     top: 0;
